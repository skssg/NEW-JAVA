...
<body>
	...
	<p>
		...
		(fmt:formatNumber value="출력할값" [groupingUsed="true|false" type="percent | currency" curencySymbol="문자"])
	</p>
	
	<c:set val="num1" value="123456789"/>
	<c:set val="num2" value="0.75"/>
	<c:set val="num3" value="50000"/>
	
	그냥 출력 : ${num1}<br>
	세자리마다 구분하여 출력 : <fmt:formatNumber value="${num1}" />
	...
	currency : <fmt:formatNumber value="${num3}" type="currency" groupingUsed="false" curencySymbol="$"/><br>
	...
	<ul>
		...
		<li>현재 날짜 : <fmt:formatDate value="${current}" type="both" pattern="yyyy-MM-do(E) HH:mm:ss(a)"/></li>
	</ul>
</body>
</html>